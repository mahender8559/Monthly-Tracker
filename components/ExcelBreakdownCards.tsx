...
export function ExcelBreakdownCards({ bankName = 'IDFC Account Money Breakdown', creditCardTransactions = [], fundTransactions = [], totalSavingsLiquidFunds, idfcItems, showBankBreakdown = true, onAddBankItem, onUpdateBankItem, onDeleteBankItem, className }: Props) {

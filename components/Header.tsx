...
interface HeaderProps { selectedMonth: string; months: string[]; cycleStartDay: number; cycleLabel: string; userEmail?: string; onMonthChange: (month: string) => void; onCycleStartDayChange: (day: number) => void; onSignOut: () => void; }

export function Header({ selectedMonth, months, cycleStartDay, cycleLabel, userEmail, onMonthChange, onCycleStartDayChange, onSignOut }: HeaderProps) {
